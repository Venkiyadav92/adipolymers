  ...
  readonly services: ServiceCard[] = [
    {
      ...
      description: 'Premium compostable carry bags manufactured from a certified Corn extract, calcium extract, tapioca extract. Every bag achieves 100% compostability in 140 days and passes all CIPET tests per ISO 17088:2021. Available in multiple sizes, thicknesses, and load capacities.',
      features: [
        'Available: flat, loop handle, D-cut, bottom seal',
        'Material: Certified Corn extract, calcium extract, tapioca extract',
    ...
    },
    {
      ...
      subtitle: '',
      description: 'Our Puducherry facility runs dedicated lines for bulk production of compostable bags. We serve supermarkets, retail chains, industries, hotels, hospitals, exporters, and government bodies. Reliable supply with consistent quality across every batch.',
      features: [
